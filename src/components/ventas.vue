<template>
  <v-app>
    <v-container>
      <template>
        <v-data-table class="mx-auto mt-5 elevation-15" max-width="900" :headers="columnas" :items="ventas" :search="search" sort-by="calories">
    <template v-slot:top>
      <v-toolbar flat>
      ...
      <v-text-field v-model="search" append-icon="mdi-magnify" label="Search" single-line hide-details></v-text-field>
        ...
        <v-dialog v-model="dialogDelete" max-width="500px">
          <v-card>
            <v-card-title class="headline">¿Esta segudo de eliminar la venta?</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
